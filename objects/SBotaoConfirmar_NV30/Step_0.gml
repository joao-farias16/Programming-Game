...
if (instance_exists(SAreaResposta_NV30) && SAreaResposta_NV30.estado_atual == ESTADO_FASE.ACERTO) && instance_exists(SAreaResposta2NV30) && SAreaResposta2NV30.estado_atual == ESTADO_FASE.ACERTO {
