if (instance_exists(SAreaResposta_NV6)) {
    ...
    // Se ainda está testando o código:
        ...
        if (string_lower(comando) == ">") {
			...
			scr_pontos_errar(SAreaResposta_NV6, 100);
			...
			with (LampadaNivel6)
			{
				...
				if (contador_erros >= 2 && nivel_dica < 1)
				{
					...
					scr_pontos_errar(SAreaResposta_NV6, 200);
				}
				...
				else if (contador_erros >= 4 && nivel_dica < 2)
				{
					...
					scr_pontos_errar(SAreaResposta_NV6, 300);
				}
				...
				else if (contador_erros >= 6 && nivel_dica < 3)
				{
					...
					scr_pontos_errar(SAreaResposta_NV6, 400);
				}
			}
