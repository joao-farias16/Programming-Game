if (instance_exists(SAreaResposta)) {
    ...
    // Se ainda está testando o código:
        ...
        if (string_lower(comando) == "print") {
			...
			scr_pontos_confirmar_acerto(SAreaResposta, "");
			...
			scr_pontos_errar(SAreaResposta, 100);
			...
			with (LampadaNivel1)
			{
				...
				if (contador_erros >= 2 && nivel_dica < 1)
				{
					...
					scr_pontos_errar(SAreaResposta, 200);
				}
				...
				else if (contador_erros >= 4 && nivel_dica < 2)
				{
					...
					scr_pontos_errar(SAreaResposta, 300);
				}
				...
				else if (contador_erros >= 6 && nivel_dica < 3)
				{
					...
					scr_pontos_errar(SAreaResposta, 400);
				}
			}
