if (instance_exists(SAreaResposta_NV28)) {
    ...
    // Se ainda está testando o código:
        ...
        if (comando == resposta_1) {
			...
			scr_pontos_confirmar_acerto(SAreaResposta_NV28, "");
			...
			scr_pontos_errar(SAreaResposta_NV28, 100);
			...
			with (LampadaNivel28)
			{
				...
				if (contador_erros >= 2 && nivel_dica < 1)
				{
					...
					scr_pontos_errar(SAreaResposta_NV28, 200);
				}
				...
				else if (contador_erros >= 4 && nivel_dica < 2)
				{
					...
					scr_pontos_errar(SAreaResposta_NV28, 300);
				}
				...
				else if (contador_erros >= 6 && nivel_dica < 3)
				{
					...
					scr_pontos_errar(SAreaResposta_NV28, 400);
				}
			}
