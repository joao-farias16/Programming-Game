if (instance_exists(SAreaResposta_Desafio1)) {
    ...
    // Se ainda está testando o código:
        ...
        if (comando == resposta_1) {
			...
			scr_pontos_confirmar_acerto(SAreaResposta_Desafio1, "");
			...
			scr_pontos_errar(SAreaResposta_Desafio1, 100);
			
			with (LampadaDesafio1)
			{
				contador_erros++;
				...
				if (contador_erros >= 2 && nivel_dica < 1)
				{
					...
					scr_pontos_errar(SAreaResposta_Desafio1, 200);
				}
				...
				else if (contador_erros >= 4 && nivel_dica < 2)
				{
					...
					scr_pontos_errar(SAreaResposta_Desafio1, 300);
				}
				...
				else if (contador_erros >= 6 && nivel_dica < 3)
				{
					...
					scr_pontos_errar(SAreaResposta_Desafio1, 400);
				}
			}
