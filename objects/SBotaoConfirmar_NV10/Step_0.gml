...
if (instance_exists(SAreaResposta_NV10) && SAreaResposta_NV10.estado_atual == ESTADO_FASE.ACERTO) && instance_exists(SAreaResposta2NV10) && SAreaResposta2NV10.estado_atual == ESTADO_FASE.ACERTO {
