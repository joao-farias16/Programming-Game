...
if (string_length(texto_digitado) > 15) {
    texto_digitado = string_copy(texto_digitado, 1, 15);
...
var digitacao_x = x + 35;
var digitacao_y = y + 1;

draw_text(digitacao_x, digitacao_y, texto_digitado);

// Cursor piscante na posição correta
if (clicado && (current_time mod 1000 < 500) && estado_atual == ESTADO_FASE.AGUARDANDO) {
    ...
    draw_line(cursor_x, digitacao_y, cursor_x, digitacao_y + altura);
}