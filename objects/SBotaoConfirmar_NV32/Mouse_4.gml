if (instance_exists(SAreaResposta_NV32)) {
    ...
    // Se ainda está testando o código:
        ...
        if (comando == resposta_1) {
			...
			scr_pontos_errar(SAreaResposta_NV32, 100);
			...
			with (LampadaNivel32)
			{
				...
				if (contador_erros >= 2 && nivel_dica < 1)
				{
					...
					scr_pontos_errar(SAreaResposta_NV32, 200);
				}
				...
				else if (contador_erros >= 4 && nivel_dica < 2)
				{
					...
					scr_pontos_errar(SAreaResposta_NV32, 300);
				}
				...
				else if (contador_erros >= 6 && nivel_dica < 3)
				{
					...
					scr_pontos_errar(SAreaResposta_NV32, 400);
				}
			}
