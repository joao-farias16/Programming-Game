...
if (estado_atual == ESTADO_FASE.ACERTO) {
    ...
    if (keyboard_check_pressed(vk_return)) {
        ...
        if (comando == "2") {
			...
			scr_pontos_errar(SAreaResposta_NV23, 100);
			...
			with (LampadaNivel23)
			{
				...
				if (contador_erros >= 2 && nivel_dica < 1)
				{
					...
					scr_pontos_errar(SAreaResposta_NV23, 200);
				}
				...
				else if (contador_erros >= 4 && nivel_dica < 2)
				{
					...
					scr_pontos_errar(SAreaResposta_NV23, 300);
				}
				...
				else if (contador_erros >= 6 && nivel_dica < 3)
				{
					...
					scr_pontos_errar(SAreaResposta_NV23, 400);
				}
			}
